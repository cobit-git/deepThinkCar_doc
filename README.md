...
#### DeeptCar 하드웨어 테스트 및 셋팅
DeeptCar 조립이 끝이나면 하드웨어를 테스트 합니다. 테스트 할 하드웨어는 다음과 같습니다. 
1. PI 카메라 
2. 뒷바퀴 구동용 DC모터 
3. 앞바퀴 조향용 서보모터 
4. 앞바퀴 조향 오프셋 조종
...
DeeptCar 하드웨어를 테스트 하는 방법은 아래 링크를 참고해 주십시오. 

[DeeptCar 하드웨어 테스트](https://cobit-git.github.io/deeptcar_doc/hardware)
